...
const REPO = 'gdgbaroda/gdg-apl-2026';

// Renderer reads config synchronously from electron/build-config.js (a <script>
// in shell.html generated by scripts/bake-config.cjs). We still inject from env
